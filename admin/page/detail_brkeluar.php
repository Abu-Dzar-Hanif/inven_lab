...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Transaki Barang Keluar #<?= $id?></h6>
    </div>
    <div class="card-body">
        <?php
    ...
    <div class="card-footer">
        <a target="_blank" href="admin/proses/ba_bk.php?i=<?= $id?>" class="btn btn-primary btn-sm my-2">Buat BA</a>
    </div>
</div>