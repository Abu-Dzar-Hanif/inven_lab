...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="admin/proses/input_tmp.php" method="post">
            ...
            <?php
            $query = mysqli_query($koneksi,"SELECT * FROM tmp JOIN tbl_barang ON tmp.kode_br=tbl_barang.id_barang JOIN tbl_brand ON tbl_barang.brand = tbl_brand.id_brand  WHERE tmp.jenis=1 AND user = '$_SESSION[id]'");
            $no = 1;
            ...
            <div class="form-group">
                <select name="tujuan" id="" class="form-control">
                    ...
                    <?php
                    $qt = mysqli_query($koneksi,"SELECT id_tujuan, tujuan FROM tbl_tujuan WHERE tipe = 'M'");
